...
(
   ...
   enter_time           datetime comment '入驻时间',
   contract_time_start  datetime comment '有效合同开始时间',
   contract_time_end    datetime comment '有效合同结束时间',
...
(
   ...
   sale_time_start      datetime comment '商品上架时间',
