...
public class CompressPicDemo {
	...
	public static void main(String[] arg) {
		...
		System.out.println("输入的图片大小：" + mypic.getPicSize("e:\\IMG_2058.JPG") / 1024 + "KB");
		int count = 0; // 记录全部图片压缩所用时间
		for (int i = 0; i < 1; i++) {
			int start = (int) System.currentTimeMillis(); // 开始时间
			mypic.compressPic("E:\\", "E:\\test\\", "IMG_2058.JPG", "r1_2058_" + i + ".jpg", 200, 200, true);
			mypic.compressPic("E:\\", "E:\\test\\", "IMG_2058.JPG", "r2_2058_" + i + ".jpg", 800, 600, true);
